(** Reflective simplification tactic [rasimpl]

  The [rasimpl] tactic is defined once and for all but can be extended using
  type classes. Syntax files define their own instances.
